...
import com.nightstalker.artic.network.ApiConstants.AICENDAT
import com.nightstalker.artic.network.ApiConstants.AICSTARTAT
...
interface ExhibitionsApi {
    @GET("exhibitions/{$ID}?fields=$ID,$IMAGE_URL,$GALLERY_TITLE,$TITLE,$ALT_IMAGE_IDS,$STATUS,$SHORT_DESCRIPTION,$AICSTARTAT,$AICENDAT")
    suspend fun getExhibitionById(@Path(ID) id: Int): ExhibitionModel

    @GET("exhibitions/search?sort[aic_end_at]=DESC&fields=$ID,$IMAGE_URL,$GALLERY_TITLE,$TITLE,$ALT_IMAGE_IDS,$STATUS,$SHORT_DESCRIPTION,$AICSTARTAT,$AICENDAT")
